...
from superset.utils.core import get_AmaraRaja_default_schema
from superset.utils.database import get_Amararaja_database
from superset.utils.decorators import transaction


class ImportAmaraRajaCommand(ImportModelsCommand):
    """Import examples"""
    ...
    def _import(  # pylint: disable=too-many-locals, too-many-branches  # noqa: C901
        ...
        examples_db = get_Amararaja_database()
        ...
        for file_name, config in configs.items():
            if file_name.startswith("datasets/"):
                ...
                if config["schema"] is None:
                    config["schema"] = get_AmaraRaja_default_schema()
